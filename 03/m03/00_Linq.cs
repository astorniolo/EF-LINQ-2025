namespace m03
{
	// Que es linq? 
	/*
		Language Integrated Query (LINQ) es una característica de .NET que permite realizar consultas 
	      a diferentes fuentes de datos de manera coherente y legible. 
	      LINQ proporciona una sintaxis unificada para trabajar con datos en memoria (como colecciones de objetos) 
	      y datos externos (como bases de datos y servicios web).

		LINQ permite a los desarrolladores escribir consultas utilizando una sintaxis similar a SQL, 
	      pero integrada en el lenguaje de programación C#.
	      Esto facilita la manipulación y consulta de datos sin necesidad de aprender 
	      diferentes lenguajes de consulta para cada fuente de datos.

		LINQ ofrece varios beneficios, como 
			la capacidad de realizar consultas de manera declarativa, 
			la integración con el sistema de tipos de C#, y 
			la posibilidad de aprovechar las capacidades de optimización del proveedor de datos subyacente.
	*/
	...
	public class _00_Linq
	{
		...
		/*
			...
			5.	IQueryable:
		        IQueryable es una interfaz que permite interactuar con proveedores de datos remotos, 
