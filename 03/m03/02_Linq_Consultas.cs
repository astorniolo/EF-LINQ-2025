...
namespace m03
{
	...
	{
		// En LINQ, las consultas permiten interactuar con colecciones de datos en C# y
		// otros lenguajes .NET. Se pueden escribir de dos formas:
		// Query Syntax y Method Syntax, que, aunque se escriben de manera diferente,
		// producen los mismos resultados.

		/*
		 (Sintaxis de consulta)
			La Query Syntax en LINQ tiene una estructura similar a SQL, 
		    usando palabras clave como from, where y select, 
		    siendo intuitiva para quienes conocen SQL.
		*/

		/*
		 (Sintaxis de método)
				La Method Syntax en LINQ usa métodos de extensión como
		        Where, OrderBy y Select, junto con expresiones lambda, 
		        siendo más programática.
		 */
