namespace m03
{
	public class _01_Linq_Basico
	{
		...
		private static void Ejemplo1_ConsultaColeccion()
		{
			...
			Console.WriteLine("Sintaxis Consulta");   // Sx Consulta = SQL
			...
			var consultaMth = numeros.Where(num => num % 2 == 0);   // el methodo espera una exp lambda para evaluar
		...
		private static void Ejemplo3_UnionConsultas()
		{
			...
			// Generar números pares del 1 al 10 y filtrar por pares
